...
public class Asfaltos_salidas_fragment extends Fragment {

    public static final String apiasfaltossalidas = "http://santafeinversiones.org/api/asfalto/salidas";
    private RequestQueue mRequestQueue;
    private StringRequest mStringRequest;


    public Asfaltos_salidas_fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.asfaltos_salidas_fragment, container, false);
    }
    ...
    private void getInfoSalidas(){
        mRequestQueue = Volley.newRequestQueue(getActivity().getApplicationContext());
        mStringRequest = new StringRequest(Request.Method.GET, apiasfaltossalidas, new Response.Listener<String>() {
            @Override
